...
#pragma warning disable CA1822 // EventStore replay convention requires an Apply overload for rejection events.
    public void Apply(WorkItemConversationLinkRejected e)
        => ArgumentNullException.ThrowIfNull(e);
#pragma warning restore CA1822
    ...
    public void Apply(ReEstimated e)
    {
        ...
        // Consume a corrupted negative or mismatched-unit event for replay sequencing while retaining
        // the last valid effort, matching the roll-up projection's retention behavior.
    ...
    public void Apply(ConversationLinked e)
    {
        ArgumentNullException.ThrowIfNull(e);
        ArgumentNullException.ThrowIfNull(e.ConversationCorrelationId);
        ConversationCorrelationId ??= e.ConversationCorrelationId;
        Sequence = e.Sequence;
    }
