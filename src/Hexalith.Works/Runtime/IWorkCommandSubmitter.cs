...
/// <param name="Payload">The command serialized with case-preserving property names. The EventStore aggregate
/// adapter's shared case-insensitive reader also accepts camelCase compatibility input.</param>
