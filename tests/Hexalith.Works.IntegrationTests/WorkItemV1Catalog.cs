...
internal static class WorkItemV1Catalog
{
    ...
    [
        ...
        new WorkItemSuspended("work-001", 5, Tenant, Item, [new AwaitCondition(Child)]),
        new WorkItemResumed("work-001", 6, Tenant, Item, new AwaitCondition(Child)),
        ...
        new SuspendWorkItem(Tenant, Item, [new AwaitCondition(Child)]),
        new ResumeWorkItem(Tenant, Item, new AwaitCondition(Child)),
