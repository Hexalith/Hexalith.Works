...
The 25 `*.v1.json` files in this directory are raw event payload bytes returned by the pinned
...
`EventPersisterGoldenCorpusTests` binds filenames bidirectionally to all 15 success and 10 rejection
