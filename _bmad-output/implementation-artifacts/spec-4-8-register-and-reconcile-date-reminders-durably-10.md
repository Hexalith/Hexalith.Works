...
- 2026-09-20 — Spec-11 closed all six remaining review actions, including classifying the alleged swallowed probe
  failure as false and pinning the existing rethrow with a direct regression. Deterministic verification is green;
  the pre-edit AppHost baseline blocker adds no fresh Tier-3 credit.
